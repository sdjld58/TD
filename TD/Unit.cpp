...
std::string Unit::getUIName(int id) {
    if (id == 1) return "  [1] 늑대\n";
    else if (id == 2) return "  [2] 박쥐\n";
    else if (id == 3) return "  [3] 곰\n";
    else if (id == 4) return "  [4] 저주받은 늑대\n";
    else if (id == 5) return "  [5] 갈기 박쥐\n";
    else if (id == 6) return "  [6] 저주받은 곰\n";
    else if (id == 7) return "  [7] 푸른색 전갈\n";
    else if (id == 8) return "  [8] 설원 늑대\n";
    else if (id == 9) return "  [9] 설원 곰\n";
    else return "  오류";
}